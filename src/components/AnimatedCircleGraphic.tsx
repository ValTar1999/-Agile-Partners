...
export default function AnimatedCircleGraphic({
  ...
  return (
    ...
    >
        ...
        <>
          <motion.path
            ...
            transition={{
              ...
              ease: CIRCLE_EASE,
              delay: delay + MIDDLE_CIRCLE_RING.delay,
            }}
          />
          <motion.path
            ...
            transition={{
              ...
              ease: CIRCLE_EASE,
              delay: delay + MIDDLE_CIRCLE_DIAMETER.delay,
            }}
          />
          {MIDDLE_CIRCLE_MERIDIANS.map(({ from, to, delay: meridianDelay, duration }) => (
            <motion.path
              key={to}
              stroke={CIRCLE_STROKE}
              strokeWidth={strokeWidth}
              ...
              transition={{
                d: { duration, ease: CIRCLE_EASE, delay: delay + meridianDelay },
                opacity: { duration: 0.01, delay: delay + meridianDelay },
              }}
            />
          ))}
        </>
      ...
      {type === 'target' &&
        CIRCLE_3_RINGS.map(({ d, delay: ringDelay }) => (
          <motion.path
            key={d.slice(0, 24)}
            d={d}
            stroke={CIRCLE_STROKE}
