    ...
    <div className="w-full border-y border-white/5 container px-4 mx-auto pt-8 md:pt-10 pb-16 md:pb-36 flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-10 sm:gap-x-[108px] sm:gap-y-[72px] mt-8">
            {STATS.map(({ value, suffix, label }) => (
              <div key={label} className="flex items-start gap-4 text-white">
                ...
                <span className="text-base leading-8 -tracking-[0.48px] max-w-40 sm:max-w-32 shrink-0 text-white/90">{label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
          ...
          <path d="M98.7227 1.16699L98.7227 49.4219L50.5015 49.4219L50.5015 1.16699L98.7227 1.16699Z" fill="url(#paint1_linear)"/>
        
          <defs>
            <linearGradient id="paint0_linear" x1="42.4367" y1="64.0142" x2="6.66487" y2="50.059" gradientUnits="userSpaceOnUse">
              <stop/>
              <stop offset="1" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="paint1_linear" x1="57.5684" y1="35.9269" x2="93.2616" y2="49.9904" gradientUnits="userSpaceOnUse">
              <stop/>
              <stop offset="1" stopOpacity="0"/>
            </linearGradient>
          </defs>
