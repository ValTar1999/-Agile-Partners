    ...
    >
      <div className="w-full overflow-hidden mb-16 md:mb-32 lg:mb-60">
        ...
        >
          ...
          <span className="text-white"><span className="italic">PEOPLE</span> BUILDING</span>
        </motion.div>
      </div>
      ...
      <div className="container px-4 mx-auto">
        ...
        >
          <div className="absolute -top-20 -left-20">
            <svg xmlns="http://www.w3.org/2000/svg" width="132" height="132" viewBox="0 0 132 132" fill="none">
              <path opacity="0.2" d="M74.4511 114.408H122.213V64.8771H101.575C101.575 53.0841 109.83 42.4704 123.392 38.6377V18C109.83 18.8845 95.3836 24.781 86.8337 34.2154C78.8735 43.0601 74.4511 54.5583 74.4511 71.9529V114.408ZM9 114.408H56.7616V64.8771H36.1239C36.1239 53.0841 44.379 42.4704 57.9409 38.6377V18C44.379 18.8845 29.9326 24.781 21.3826 34.2154C13.4224 43.0601 9 54.5583 9 71.9529V114.408Z" fill="white"/>
            </svg>
          </div>
          ...
          <div className="grid gap-2 uppercase">
            <div className="font-semibold text-base leading-7 tracking-[0.32px] text-white">NAME HERE</div>
            <div className="text-base leading-7 -tracking-[0.48px] text-[#999999]">CEO OR TESTIMONIAL</div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-[168px] items-end">
          <motion.p
            ...
            transition={{ duration: 0.5, ease: 'easeOut' }}
          >
            Agile Partners was born from the encounter of passionate individuals with complementary profiles. Product management, creative direction and technological lead: they form a complete framework that passes its craft and vision to the different poles of the company.
          </motion.p>
          <motion.div
